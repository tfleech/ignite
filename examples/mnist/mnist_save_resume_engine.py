...
def run(
    ...
    pbar = tqdm(
        initial=0, leave=False, total=len(train_loader), desc=desc.format(0, lr)
    )
    ...
    trainer.add_event_handler(
        Events.ITERATION_COMPLETED(every=checkpoint_every), training_checkpoint
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=550,
        help="Checkpoint training every X iterations",
    )
    parser.add_argument(
        "--resume_from",
        type=str,
