...
from utils import get_model, get_train_test_loaders, set_seed

import ignite
from ignite.contrib.engines import common
from ignite.contrib.handlers import PiecewiseLinear, ProgressBar, TensorboardLogger
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--network", type=str, default="fastresnet", help="Network to train"
    )
    ...
    parser.add_argument(
        "--local_rank", type=int, help="Local process rank in distributed computation"
    )
